  ...
  return (
    <Section width="full" title="Balanço Mensal">
      <div className="flex gap-2">
        <div className="bg-dashboardGreen flex flex-grow flex-col gap-4 rounded-lg p-2">
          <h4 className="font-medium text-primaryDR">Receita</h4>
          <p className="text-xl font-bold text-primaryDR">
            {formatValue(data.receita)}
          </p>
        </div>
        <div className="bg-dashboardRed flex flex-grow flex-col gap-4 rounded-lg p-2">
